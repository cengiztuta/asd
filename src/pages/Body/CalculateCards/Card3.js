...
const Card3 = () => {
  ...
  const totalPrice = childCounterValue * 68 + adultCounterValue * 102;
  return (
    <Box className="Card">
      <div className="Card-header">
        <div className="Card-header-content">
          <h2 className="Card-type">
            {" "}
            {t("translation.CALCULATOR_3_day_pass")}
          </h2>
      ...
      <div className="Card-body">
        <div className="adult-calculator">
          ...
          <div className="price-section">
            ...
            <a className="adult-price">102 EUR</a>
          </div>
        ...
        <div className="adult-calculator">
          ...
          <div className="price-section">
            <a className="adult-price">68 EUR</a>
          </div>
          <div className="price-calculator">
